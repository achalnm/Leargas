    ...
    <div className="surface p-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          />
          {errors.password && (
            <p className="mt-1.5 text-xs text-[var(--color-error)]">{errors.password.message}</p>
          )}
        </div>

        {error && (
          <div className="p-3 rounded-lg bg-red-950/40 border border-red-900/50 text-xs text-red-400">
            {error}
          </div>
        )}
